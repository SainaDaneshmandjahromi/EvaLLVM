...
The project follows the design of the *Eva language* compiler introduced in an educational course on compiler construction by **Dmitry Soshnikov**.  
---

## 🚀 Overview

EvaLLVM demonstrates how a simple Lisp-like language can be compiled into LLVM Intermediate Representation (IR).  
It provides a minimal but clear example of how to build a front end that generates LLVM IR for core language features such as variables, arithmetic, and control flow.

---

## 🛠️ Build Instructions

Make sure you have **LLVM 14** installed (via Homebrew or your package manager).
